...
class LMMInterface:
    ...
    def process_data(self, video_data=None, audio_data=None, user_context=None) -> Optional[LMMResponse]:
        ...
        if user_context:
            ...
            # Truncate window title to prevent token bloat
            active_window = self._truncate_text(active_window, 60)
            ...
            if context_history:
                ...
                for snapshot in context_history:
                    ...
                    win = self._truncate_text(win, 40) # Shorter truncation for history
