...
MEETING_MODE_BLACKLIST = _get_conf("MEETING_MODE_BLACKLIST", ["YouTube", "Netflix", "VLC", "Twitch", "Hulu", "Disney+", "Prime Video"])
...
ESCALATION_NAG_INTERVAL = _get_conf("ESCALATION_NAG_INTERVAL", 15, int) # Min time between escalated interventions
MAX_INTERVENTION_TIER = _get_conf("MAX_INTERVENTION_TIER", 3, int)
...
INTERVENTION_CONFIGS = {
    ...
    "distraction_alert": {
        "tier": 2,
        "default_message": "I noticed you switched to a distraction. Do you need a break?",
        "default_duration": 30,
    }
}
