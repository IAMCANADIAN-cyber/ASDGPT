...
# Minimum time before an escalated intervention can trigger (prevents spam during escalation)
ESCALATION_NAG_INTERVAL = _get_conf("ESCALATION_NAG_INTERVAL", 15, int)
