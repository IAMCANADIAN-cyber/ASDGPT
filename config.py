...
# Thresholds (Calibrated via tools/calibrate_sensors.py)
# AUDIO_THRESHOLD_HIGH: RMS level to trigger "loud" event (0.0 - 1.0)
AUDIO_THRESHOLD_HIGH = float(os.getenv("AUDIO_THRESHOLD_HIGH", "0.5"))

# VIDEO_ACTIVITY_THRESHOLD_HIGH: Frame diff score to trigger "active" event
...
# --- LMM Configuration ---
# Local LMM Setup (OpenAI-compatible endpoint, e.g., LM Studio, LocalAI)
LOCAL_LLM_URL = os.getenv("LOCAL_LLM_URL", "http://127.0.0.1:1234")
LOCAL_LLM_MODEL_ID = os.getenv("LOCAL_LLM_MODEL_ID", "deepseek/deepseek-r1-0528-qwen3-8b")
