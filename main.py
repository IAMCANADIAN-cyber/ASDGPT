...
class Application:
    ...
    def on_feedback_helpful_pressed(self) -> None:
        ...
        # Provide visual feedback via tray icon flash (Green/OK)
        if self.tray_icon:
             self.tray_icon.flash_icon(flash_status="feedback_helpful", duration=0.5, flashes=1)
    ...
    def on_feedback_unhelpful_pressed(self) -> None:
        ...
        # Provide visual feedback via tray icon flash (Red/NO)
        if self.tray_icon:
             self.tray_icon.flash_icon(flash_status="feedback_unhelpful", duration=0.5, flashes=1)
