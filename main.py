...
class Application:
    ...
    def _shutdown(self) -> None:
        ...
        # Release sensors early to unblock any I/O waits in workers
        if hasattr(self, 'video_sensor') and self.video_sensor: self.video_sensor.stop()
        if hasattr(self, 'audio_sensor') and self.audio_sensor: self.audio_sensor.stop()
