...
class Application:
    ...
    def _shutdown(self) -> None:
        ...
        # Release sensors BEFORE joining threads to unblock any I/O calls
        if hasattr(self, 'video_sensor') and self.video_sensor:
            self.data_logger.log_info("Releasing video sensor to unblock worker...")
            self.video_sensor.release()

        if hasattr(self, 'audio_sensor') and self.audio_sensor:
            self.data_logger.log_info("Releasing audio sensor to unblock worker...")
