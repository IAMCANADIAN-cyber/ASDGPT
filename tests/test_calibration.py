...
class TestCalibration(unittest.TestCase):
    def setUp(self):
        ...
        # Important: We patch the CLASSES so that when CalibrationEngine instantiates them,
        # it gets our mock instances.
    ...
    def test_calibrate_audio_silence(self):
        ...
        # Setup the mock sensor to return a concrete threshold value
    ...
    def test_full_run_flow(self):
        ...
        # Verify flow
        engine.calibrate_audio_silence.assert_called()
        engine.calibrate_video_posture.assert_called()
