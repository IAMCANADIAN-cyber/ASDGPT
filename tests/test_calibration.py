...
class TestCalibration(unittest.TestCase):
    ...
    def test_calibrate_video_posture(self):
        ...
        # Mock VideoSensor.calibrate return value
        expected_baseline = {
             "face_detected": True,
             "face_roll_angle": 5.0,
             "face_size_ratio": 0.2,
        ...
        # Verify VideoSensor.calibrate was called
