...
class TestDNDMode(unittest.TestCase):
    ...
    def test_active_triggers_high_audio(self, mock_thread):
        ...
        mock_payload = {'data': 'mock', 'user_context': {'sensor_metrics': {}}, 'video_data': None, 'audio_data': None}
    ...
    def test_dnd_monitors_high_audio(self, mock_thread):
        ...
        with patch.object(self.engine, '_prepare_lmm_data', return_value={'data': 'mock', 'user_context': {'sensor_metrics': {}}, 'video_data': None, 'audio_data': None}):
            self.engine.update()
