...
def test_process_data_success(mock_post, lmm_interface):
    ...
    # Inject latency manually into expected since process_data adds it
    # But since we mock time in some tests, latency might vary.
    # We'll just check the core fields.
